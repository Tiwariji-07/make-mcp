          ...
          <div className="flex-1 flex flex-col justify-center px-8 md:px-16 lg:px-24 py-20">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground leading-relaxed max-w-md">
                Your spec never leaves your machine. Import OpenAPI or Postman
                specs, select endpoints, and export production-ready Model
                Context Protocol servers in TypeScript or Python — all in your
                browser.
              </p>
